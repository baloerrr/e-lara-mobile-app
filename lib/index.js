...
//       beasiswa.jurusan.some((jurusan) => userVector.jurusan.includes(jurusan)),
//       userVector.tipePendanaan === beasiswa.tipePendanaan,
//       userVector.jenjang.includes('Semua Jenjang') ||
//       beasiswa.jenjang.some((jenjang) => userVector.jenjang.includes(jenjang)),
...
function calculateMatchingValues(userVector, beasiswa) {
  return [
    ...
    userVector.semester >= beasiswa.semester,
    userVector.jurusan.includes('Semua Jurusan') ||
      (beasiswa.jurusan && beasiswa.jurusan.some((jurusan) => userVector.jurusan.includes(jurusan))),
    userVector.tipePendanaan === beasiswa.tipePendanaan,
    userVector.jenjang.includes('Semua Jenjang') ||
      (beasiswa.jenjang && beasiswa.jenjang.some((jenjang) => userVector.jenjang.includes(jenjang))),
    userVector.rangeUangSaku === beasiswa.rangeUangSaku,
  ];
}
